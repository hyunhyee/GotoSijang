...
<!-- 댓글 부분 -->
<div class="maincontainer2" style="width: 1300px; height: 600px; float: left; margin-top: 20px; margin-left: 740px;">
  <div class="row">
 ...
 <script type="text/javascript">
        ...
        function commentList(result) {
        	...
        	for(var i in result) {
        		...
        		output +="<div class='comment-box' style='padding-top: 38px; margin-top: 70px; '>";
